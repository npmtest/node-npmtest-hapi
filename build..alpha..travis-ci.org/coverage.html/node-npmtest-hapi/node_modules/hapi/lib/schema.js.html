...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-hapi/node_modules/hapi/lib/schema.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-hapi/node_modules/hapi/lib/schema.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-hapi/node_modules/hapi/lib/</a> &#187; schema.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
exports.apply = <span class="fstat-no" title="function not covered" >function (type, options, message) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    const result = Joi.validate(options, internals[type]);</span>
<span class="cstat-no" title="statement not covered" >    Hoek.assert(!result.error, 'Invalid', type, 'options', message ? '(' + message + ')' : '', result.error &amp;&amp; result.error.annotate());</span>
